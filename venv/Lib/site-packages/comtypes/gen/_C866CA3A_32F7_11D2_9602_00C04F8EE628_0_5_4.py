...
__all__ = [
    ...
    'SPFM_OPEN_READWRITE', 'SVP_2', 'SpeechAudioFormatGUIDWave',
    'SVSFIsFilename', 'SPEI_END_INPUT_STREAM', 'SECFNoSpecialChars',
    'DISPID_SRSetPropertyString', 'SDKLCurrentUser', 'SINone',
    'DISPID_SpeechObjectToken', 'DISPID_SRCResume',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRName',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'STCAll', 'SVP_8',
    'SpeechPropertyHighConfidenceThreshold', 'SITooFast', 'SITooSlow',
    'ISpeechPhraseRule', 'SpeechRuleAttributes', 'SPPS_Modifier',
    'SSFMOpenForRead', 'SpeechVoiceSpeakFlags',
    'ISpeechGrammarRuleState', 'DISPID_SPACommit',
    'DISPID_SWFEChannels', 'SAFT48kHz8BitMono', 'SpStream',
    'DISPID_SLWsItem', 'SASStop', 'SpeechStreamSeekPositionType',
    'ISpNotifyTranslator', 'SpeechTokenKeyFiles', 'DISPID_SLWsCount',
    'SWPUnknownWordPronounceable', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SASFreeBufferSpace', 'SPCT_DICTATION',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SAFGuid',
    'DISPID_SLGenerationId', 'DISPID_SpeechXMLRecoResult', 'SVP_18',
    'eLEXTYPE_RESERVED7', 'ISpeechPhraseInfo',
    'DISPID_SPEDisplayAttributes', 'SPRECOGNIZERSTATUS',
    'ISpRecoGrammar2', 'SPVOICESTATUS',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SABIBufferSize',
    'DISPID_SGRsFindRule', 'DISPID_SRRTLength', 'SpeechAudioVolume',
    'DISPID_SVESentenceBoundary', 'DISPID_SPPsItem',
    'SGDSActiveUserDelimited', 'SRADynamic',
    'SpeechGrammarTagDictation', 'SPEI_RESERVED3',
    'SPSEMANTICERRORINFO', 'DISPID_SDKCreateKey', 'DISPID_SVVoice',
    'DISPID_SPCIdToPhone', 'SPAUDIOSTATE', 'SLOStatic',
    'SPDKL_LocalMachine', 'DISPID_SRGIsPronounceable',
    'DISPID_SDKGetBinaryValue', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpNotifySource', 'ISpeechLexiconPronunciation',
    'SDA_No_Trailing_Space', 'SAFTGSM610_8kHzMono', 'DISPID_SVResume',
    'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE1', 'DISPID_SLPsCount',
    'SPADAPTATIONRELEVANCE', 'SFTInput', 'SRERequestUI',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPIRule', 'SWTDeleted',
    'eLEXTYPE_PRIVATE19', 'SECFEmulateResult',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SLPPhoneIds',
    'IInternetSecurityManager', 'SpeechFormatType',
    'SRTExtendableParse', 'SPSERIALIZEDPHRASE', 'DISPID_SOTCId',
    'SPSHT_OTHER', 'tagSTATSTG', 'SSSPTRelativeToStart',
    'DISPID_SRGetFormat', 'SSTTDictation', 'SPLO_DYNAMIC',
    'SPSHT_Unknown', 'SPWORDPRONOUNCEABLE',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPAs_NewEnum',
    'DISPID_SPEDisplayText', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechAudio', 'SpeechTokenValueCLSID', 'SSFMCreate',
    'eLEXTYPE_RESERVED9', 'SAFTNoAssignedFormat',
    'DISPID_SVAudioOutputStream', 'DISPID_SRGId',
    'SVEStartInputStream', 'SVPOver', 'SRADefaultToActive',
    'SpPhoneticAlphabetConverter', 'DISPID_SDKDeleteKey',
    'SGLexicalNoSpecialChars', 'SPPS_Unknown', 'SECFDefault',
    'DISPID_SRCEStartStream', 'DISPID_SVAlertBoundary',
    'SpeechGrammarTagWildcard', 'DISPID_SpeechRecoContextEvents',
    'SAFT32kHz8BitStereo', 'SP_VISEME_2', 'LONG_PTR',
    'SAFT44kHz16BitMono', 'SAFTGSM610_11kHzMono',
    'DISPID_SRDisplayUI', 'DISPID_SPPEngineConfidence',
    'DISPID_SRCEBookmark', 'SAFT8kHz8BitMono',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPHRASE', 'DISPID_SPARecoResult',
    'SAFT12kHz8BitStereo', 'SVEPhoneme', 'DISPID_SPRuleName',
    'ISpeechPhraseElement', 'SVP_16', 'ISpeechLexiconPronunciations',
    'eLEXTYPE_MORPHOLOGY', 'SpResourceManager',
    'SpeechTokenShellFolder', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE18', 'SPRS_ACTIVE', 'SpeechLexiconType',
    'SpNullPhoneConverter', 'ISpGrammarBuilder',
    ...
    'DISPID_SAFGetWaveFormatEx', 'SP_VISEME_11', 'SDTPronunciation',
    'SPRST_INACTIVE', 'SDA_Two_Trailing_Spaces', 'IEnumString',
    'DISPID_SFSClose', 'SGSExclusive', 'SVEPrivate',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPERequiredConfidence',
    'SWPUnknownWordUnpronounceable', 'SpeechDataKeyLocation',
    'SpWaveFormatEx', 'DISPID_SRRAlternates', 'SAFT32kHz16BitStereo',
    'SpeechLoadOption', 'SPLOADOPTIONS', 'ISpeechGrammarRules',
    'SPDKL_DefaultLocation', 'SP_VISEME_13',
    'DISPID_SWFEBitsPerSample', 'SpSharedRecognizer',
    'SpTextSelectionInformation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_8',
    'DISPID_SpeechDataKey', 'SPVPRI_ALERT',
    'DISPID_SpeechGrammarRuleStateTransition', 'STSF_LocalAppData',
    'SVP_13', 'DISPID_SVEBookmark', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPBINARYGRAMMAR', 'SPEI_MIN_SR', 'ISpeechPhraseProperty',
    'SPEI_MAX_TTS', 'ISpeechRecognizerStatus',
    'ISpeechResourceLoader', 'DISPID_SGRSTsCount', 'SVSFParseSsml',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechRecognizer',
    'DISPID_SRCEventInterests', 'SP_VISEME_20',
    'SpObjectTokenCategory', 'SRAImport',
    'DISPID_SLRemovePronunciation', 'SPWORD',
    'DISPIDSPTSI_ActiveOffset', 'SPSHORTCUTPAIRLIST',
    'ISpeechFileStream', 'SpeechPartOfSpeech', 'SPGS_DISABLED',
    'SPBOOKMARKOPTIONS', 'SPWAVEFORMATTYPE', 'DISPID_SGRSTNextState',
    'SP_VISEME_19', 'SPGS_ENABLED', 'SpeechRecoEvents',
    'SPAR_Unknown', 'ISpNotifySink', 'SECFIgnoreCase',
    'ISpeechAudioFormat', 'DISPID_SPAsCount', 'ISpRecognizer3',
    'SAFT22kHz16BitMono', 'DISPID_SGRSTRule', 'SPSUnknown',
    'DISPID_SRGRecoContext', 'DISPID_SAEventHandle', 'DISPID_SVPause',
    'SPEI_SR_PRIVATE', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SLPsItem',
    'SAFT8kHz8BitStereo', 'SAFT24kHz16BitMono', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_PRIVATE7',
    'DISPIDSPTSI_SelectionLength', 'ISpeechTextSelectionInformation',
    'SRAInterpreter', 'SpMMAudioOut', 'DISPID_SBSFormat',
    'DISPID_SLPLangId', 'SPPHRASEELEMENT', 'DISPID_SASetState',
    'DISPID_SVEEnginePrivate', 'DISPID_SRCCmdMaxAlternates',
    'ISpPhraseAlt', 'DISPID_SWFEFormatTag', 'SPEI_RESERVED2',
    'SAFTGSM610_44kHzMono', 'DISPID_SRRSetTextFeedback', 'ISpDataKey',
    'SpeechRecognizerState', 'ISpeechLexicon', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechPhraseReplacement',
    'ISpeechGrammarRuleStateTransitions', 'SAFTADPCM_22kHzStereo',
    'SpCompressedLexicon', 'DISPID_SGRInitialState',
    'SpeechAudioFormatType', 'SPPS_Interjection', 'SPRULE',
    'DISPID_SGRSRule', 'DISPID_SVEPhoneme', 'SpInprocRecognizer',
    'SAFT32kHz16BitMono', 'SGSEnabled', 'DISPID_SPRules_NewEnum',
    'IStream', 'ISpeechRecognizer', 'ISpeechWaveFormatEx',
    'SpeechCategoryAudioOut', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechInterference', 'SVP_14', 'SPPHRASEREPLACEMENT',
    'SRCS_Disabled', 'DISPID_SLWType', 'SP_VISEME_18',
    'DISPID_SPPFirstElement', 'SpeechDictationTopicSpelling',
    'DISPID_SPIAudioSizeBytes', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechWaveFormatEx', 'SGDisplay', 'SpMemoryStream',
    'DISPID_SLWWord', 'Speech_StreamPos_Asap',
    'DISPID_SPELexicalForm', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPPs_NewEnum',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPIElements',
    'SPEI_SR_BOOKMARK', 'SVEViseme', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRGetRecognizers', 'DISPID_SRCEAdaptation',
    'DISPID_SGRId', 'SPAS_PAUSE', 'SGRSTTWord', 'SAFT8kHz16BitMono',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPPParent',
    'SPCS_DISABLED', 'SpeechEngineProperties', 'SRESoundEnd',
    'ISpPhoneConverter', 'DISPID_SpeechPhraseElements',
    'SPSInterjection', 'SAFT16kHz16BitMono', 'SPSFunction',
    'SAFT44kHz8BitStereo', 'SPAR_Low', 'ISpPhoneticAlphabetConverter',
    'SRAONone', 'DISPID_SDKSetBinaryValue', 'SITooLoud',
    'ISpeechPhraseElements', 'SFTSREngine',
    'DISPID_SpeechPhraseProperties', 'DISPID_SABIMinNotification',
    'SDTLexicalForm', 'SPEI_VISEME', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE17', 'SPRECOSTATE', 'DISPID_SLGetPronunciations',
    'SECNormalConfidence', 'SAFT32kHz8BitMono', 'SGDSInactive',
    'SPAR_Medium', 'DISPID_SpeechVoiceStatus', 'eLEXTYPE_APP',
    'Speech_Max_Pron_Length', 'ISpeechRecoResult',
    'SAFT44kHz16BitStereo', 'DISPID_SRSetPropertyNumber',
    'SpeechBookmarkOptions', 'DISPID_SGRSTsItem',
    'DISPID_SVEStreamEnd', 'ISpeechRecoResultTimes',
    'ISpPhoneticAlphabetSelection', 'DISPID_SOTCreateInstance',
    'DISPID_SVSpeakStream', 'DISPID_SRStatus', 'DISPIDSPTSI',
    ...
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPVPRI_NORMAL',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRSTText', 'SLTUser',
    'SpVoice', 'DISPID_SRRTTickCount', 'SPRULESTATE',
    'SAFT11kHz8BitMono', 'DISPID_SPAsItem',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRClear',
    'SDKLLocalMachine', 'SREBookmark', 'SPEI_VOICE_CHANGE',
    'DISPID_SGRsDynamic', 'SPEI_RECOGNITION',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVESentenceBoundary', 'SASPause',
    'SpShortcut', 'Speech_Default_Weight', 'SVF_Stressed',
    ...
    'DISPID_SVWaitUntilDone', 'SPBO_PAUSE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechAudioState',
    'DISPID_SVRate', 'SpLexicon', 'SINoise', 'SPWF_INPUT',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseRules', 'SPPS_RESERVED3', 'eLEXTYPE_PRIVATE9',
    'DISPID_SGRSTPropertyId', 'SpeechRecoContextState',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPRuleId',
    'DISPID_SOTGetStorageFileName', 'SPCT_SUB_DICTATION',
    'SP_VISEME_5', 'DISPID_SVEVoiceChange',
    'DISPID_SRCEEnginePrivate', 'SPBO_TIME_UNITS',
    'SAFTADPCM_8kHzMono', 'ISpeechPhraseAlternate',
    'SPDATAKEYLOCATION', 'SVP_9', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGCmdLoadFromMemory', 'SGSDisabled', 'SPBO_AHEAD',
    'ISpRecoCategory', 'DISPID_SASCurrentDevicePosition',
    ...
    'DISPID_SWFEAvgBytesPerSec', 'SpeechWordPronounceable',
    'DISPID_SpeechRecognizerStatus', 'STCInprocHandler', 'SVF_None',
    'STSF_FlagCreate', 'DISPID_SLGetWords', 'eLEXTYPE_PRIVATE4',
    'SAFT11kHz16BitMono', 'SPSNoun', 'DISPID_SRRTimes',
    'DISPID_SVGetAudioInputs', 'SpeechRetainedAudioOptions',
    'eLEXTYPE_PRIVATE2', 'SPPHRASEPROPERTY', 'ISpStreamFormat',
    'SVP_15', 'DISPID_SWFEBlockAlign', 'SpeechPropertyAdaptationOn',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTADPCM_22kHzMono',
    'ISpeechLexiconWords', 'eLEXTYPE_PRIVATE14', 'DISPID_SOTId',
    'SpeechVisemeType', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechPhraseReplacements', 'SPEI_MAX_SR',
    'DISPID_SRCEPhraseStart', 'DISPID_SGRSAddSpecialTransition',
    'SpeechRecognitionType', 'SPCONTEXTSTATE', 'DISPID_SPPsCount',
    'SPEI_UNDEFINED', 'DISPID_SPPValue', 'SGPronounciation',
    'DISPID_SpeechGrammarRules', 'ISpProperties',
    'DISPID_SDKDeleteValue', 'SPINTERFERENCE_NONE',
    'DISPID_SRSAudioStatus', 'DISPID_SLAddPronunciation',
    'SpObjectToken', 'SDKLDefaultLocation', 'ISpeechObjectTokens',
    'SSSPTRelativeToEnd', 'SPRST_ACTIVE_ALWAYS', 'SPWT_DISPLAY',
    'SP_VISEME_4', 'DISPID_SVGetVoices', 'SVSFParseSapi',
    'SDTDisplayText', 'ISpeechRecoResultDispatch', 'SpPhoneConverter',
    'DISPID_SVSLastStreamNumberQueued', 'SPPS_RESERVED1',
    'SRATopLevel', 'SVF_Emphasis', 'DISPID_SDKEnumValues',
    'DISPID_SRAudioInputStream', 'SPAUDIOSTATUS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPGRAMMARSTATE',
    'DISPID_SpeechPhraseBuilder', 'STSF_AppData', 'SPWORDTYPE',
    'ISpRecoContext', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGDictationLoad', 'SPCATEGORYTYPE',
    'SpeechCategoryRecoProfiles', 'DISPID_SPISaveToMemory',
    ...
    'ISpRecoContext2', 'SP_VISEME_10', 'SpeechRuleState',
    'SVSFIsNotXML', 'SPEI_PHONEME', 'SpMMAudioIn',
    'SpSharedRecoContext', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechRecoResult2',
    'SPPS_LMA', 'DISPID_SVAudioOutput', '_SPAUDIOSTATE',
    'DISPID_SRCRequestedUIType', 'DISPID_SOTCDefault',
    'DISPID_SABufferInfo', 'eLEXTYPE_RESERVED10', 'SPEI_RESERVED5',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_10',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRSCurrentStreamPosition',
    'SPEI_SOUND_END', 'SpeechWordType', 'ISpRecognizer',
    'SAFT22kHz8BitMono', 'SRAORetainAudio', 'SAFT24kHz8BitMono',
    'DISPID_SPEPronunciation', 'DISPID_SPEActualConfidence',
    'ISpStreamFormatConverter', 'SINoSignal', 'SpeechAddRemoveWord',
    'SDTAlternates', 'SVSFParseMask', 'DISPID_SGRSTransitions',
    'SPWORDLIST', 'ISpeechRecoContext', 'DISPID_SPCPhoneToId',
    'SVEWordBoundary', 'DISPID_SPPId', 'DISPID_SGRs_NewEnum',
    'SPWF_SRENGINE', 'SDTProperty', 'SPRST_ACTIVE',
    'DISPID_SpeechLexiconPronunciation', 'SPFM_CREATE',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechLexiconWords',
    'eLEXTYPE_PRIVATE11', 'SpeechPropertyResourceUsage',
    'SECFIgnoreKanaType', 'DISPID_SVEViseme', 'DISPID_SRCBookmark',
    'ISpObjectTokenCategory', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPILanguageId', 'SREPropertyStringChange',
    'SpeechVoiceEvents', 'SREFalseRecognition', 'SAFT12kHz16BitMono',
    'DISPID_SCSBaseStream', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPPConfidence', 'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE13',
    'SP_VISEME_16', 'SAFTCCITT_uLaw_11kHzMono', 'SPAUDIOBUFFERINFO',
    'SPEI_INTERFERENCE', 'eLEXTYPE_PRIVATE8', 'SECLowConfidence',
    'DISPID_SGRSAddRuleTransition', 'SPBO_NONE',
    'ISpeechXMLRecoResult', 'SP_VISEME_3', 'DISPID_SRIsShared',
    'SPVPRIORITY', 'DISPID_SOTSetId', 'SVSFDefault', 'SVPNormal',
    'ISpeechVoiceStatus', 'DISPID_SVSCurrentStreamNumber',
    'SPPS_Noncontent', 'SP_VISEME_1', 'SECHighConfidence',
    'DISPID_SBSRead', 'DISPID_SRGDictationSetState', 'SGLexical',
    'DISPID_SLGetGenerationChange', 'DISPID_SpeechVoice',
    'SSSPTRelativeToCurrentPosition', 'SPDKL_CurrentUser',
    'SPEI_RESERVED6', 'SVP_7', 'DISPIDSPTSI_SelectionOffset',
    'ISpObjectWithToken', 'tagSPPROPERTYINFO', 'SVP_0',
    'DISPID_SRRSaveToMemory', 'DISPID_SMSAMMHandle', 'ISpVoice',
    'eLEXTYPE_LETTERTOSOUND', 'SPAR_High',
    'DISPID_SPIGetDisplayAttributes', 'SPPS_SuppressWord',
    'DISPID_SPPChildren', 'SASRun', 'DISPID_SABIEventBias',
    'SpeechEmulationCompareFlags', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRRTStreamTime', 'DISPID_SGRsCount', 'SRSActiveAlways',
    'SRERecoOtherContext', 'SVP_20', 'SREPhraseStart',
    'DISPID_SWFEExtraData', 'DISPID_SOTDataKey', 'SpNotifyTranslator',
    'STCInprocServer', 'DISPID_SBSWrite', 'SAFT11kHz16BitStereo',
    'SPINTERFERENCE_NOISE', 'DISPID_SDKOpenKey', 'SpMMAudioEnum',
    'SAFT12kHz16BitStereo', 'ISpObjectToken',
    'DISPID_SDKSetStringValue', 'SRSEDone', 'SPAS_RUN',
    'SpeechAudioProperties',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPAS_CLOSED',
    'ISpeechObjectTokenCategory', 'DISPID_SRRAudioFormat', 'SVP_17',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechMMSysAudio',
    'SVEBookmark', 'ISpRecognizer2', 'SPWT_LEXICAL',
    'DISPID_SRCERequestUI', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPIReplacements', 'DISPID_SOTCSetId',
    'DISPID_SpeechAudio', 'SVSFNLPMask', 'SPSHT_NotOverriden',
    'eLEXTYPE_PRIVATE10', 'SPINTERFERENCE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPWORDPRONUNCIATION',
    'SAFT16kHz8BitMono', 'SP_VISEME_15', 'DISPID_SPRuleFirstElement',
    'SRARoot', 'SAFT48kHz16BitMono', 'SpStreamFormatConverter',
    'SVSFUnusedFlags', 'SpeechVisemeFeature', 'SPFM_CREATE_ALWAYS',
    'ISpLexicon', 'DISPID_SPIAudioSizeTime', 'UINT_PTR',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVSpeak',
    'DISPID_SVSPhonemeId', 'DISPID_SDKSetLongValue', 'SP_VISEME_6',
    'SPPS_Function', 'SPRS_INACTIVE', 'ISpEventSource',
    'DISPID_SRState', 'SVSFlagsAsync', 'DISPID_SVSLastBookmark',
    'SpUnCompressedLexicon', 'DISPID_SRGCmdSetRuleIdState',
    'eLEXTYPE_RESERVED6', 'SVEAllEvents', 'SVSFNLPSpeakPunc',
    ...
    'DISPID_SVEventInterests', 'DISPID_SLWLangId', 'SDTAudio',
    'SPSNotOverriden', 'DISPID_SVSkip', 'DISPID_SPCLangId',
    'SPEI_HYPOTHESIS', 'ISpeechGrammarRule',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechObjectTokens',
    'DISPID_SRGRules', 'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE16',
    'SPTEXTSELECTIONINFO', 'SRESoundStart', 'SPAUDIOOPTIONS',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCRecognizer',
    'SDTReplacement', 'SpeechCategoryVoices',
    'DISPID_SpeechCustomStream', 'SPXRO_SML', 'SPEI_WORD_BOUNDARY',
    'SPFILEMODE', 'SPEI_RESERVED1', 'SBONone', 'SREStreamStart',
    'SPFM_NUM_MODES', 'DISPID_SMSGetData', 'SPSMF_UPS',
    'DISPID_SLWPronunciations', 'SAFT16kHz16BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPINTERFERENCE_TOOLOUD',
    'SPVPRI_OVER', 'DISPID_SFSOpen', 'DISPID_SVEAudioLevel',
    'SPCT_SLEEP', 'DISPID_SASState', 'ISpeechPhraseAlternates',
    'SVP_6', 'SPWT_PRONUNCIATION', 'DISPID_SRCESoundStart',
    'SP_VISEME_21', 'DISPID_SPEAudioSizeTime', 'DISPID_SOTsItem',
    'DISPID_SpeechLexicon', 'DISPID_SRAudioInput', 'ISpMMSysAudio',
    'SpeechCategoryPhoneConverters', 'WAVEFORMATEX', 'SLTApp',
    'SPAO_NONE', 'SVSFIsXML', 'ISpeechAudioStatus',
    'DISPID_SRRRecoContext', 'DISPID_SOTCategory',
    'SPSERIALIZEDRESULT', 'DISPID_SPIProperties',
    'DISPID_SRCRetainedAudio', 'ISpeechCustomStream',
    'STCRemoteServer', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SDKEnumKeys',
    'SREStateChange', 'SPAS_STOP', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SASNonBlockingIO', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SVSLastResult', 'SGRSTTTextBuffer',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRCESoundEnd',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SOTGetAttribute',
    'SPEI_MIN_TTS', 'DISPID_SRCPause', 'SAFTADPCM_44kHzMono',
    'DISPID_SRCERecognition', 'SVP_5', 'DISPID_SGRSTType',
    'SpeechGrammarTagUnlimitedDictation', 'SPEI_FALSE_RECOGNITION',
    'SRSEIsSpeaking', 'ISpShortcut',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SAFSetWaveFormatEx',
    'SPRECORESULTTIMES', 'SPDKL_CurrentConfig',
    'DISPID_SpeechPhraseInfo', 'SVP_21', 'SDTRule', 'DISPID_SPEsItem',
    'DISPID_SVSpeakCompleteEvent', 'SPEI_RECO_OTHER_CONTEXT',
    'SPSSuppressWord', 'DISPID_SOTRemove', 'SPSVerb', 'SVP_1',
    ...
    'DISPID_SRGetPropertyString', 'SVP_12', 'SPEI_ADAPTATION',
    'DISPID_SVVolume', 'SAFT44kHz8BitMono', 'DISPID_SPPName',
    'ISpStream', 'SpeechTokenKeyAttributes', 'DISPID_SVSRunningState',
    'SPPS_Verb', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVEWord',
    'DISPID_SGRSTs_NewEnum', 'SRTAutopause', 'SVP_11',
    'SPCT_SUB_COMMAND', 'DISPID_SRGCmdLoadFromFile',
    'eWORDTYPE_ADDED', 'SPEI_PHRASE_START', 'SPEI_REQUEST_UI',
    'DISPID_SPIGetText', 'SAFT11kHz8BitStereo',
    'SDA_One_Trailing_Space', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPEVENTSOURCEINFO', 'DISPID_SAStatus', 'DISPID_SGRsItem',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'eLEXTYPE_VENDORLEXICON', 'SPPS_NotOverriden',
    'SVEEndInputStream', 'eLEXTYPE_PRIVATE3', 'SPRST_NUM_STATES',
    'SVP_3', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SpeechRecoResult', '_ISpeechRecoContextEvents',
    'ISpeechBaseStream', 'eWORDTYPE_DELETED', 'ISpeechPhoneConverter',
    'DISPID_SPRText', 'DISPID_SRGReset', 'SBOPause',
    'SGDSActiveWithAutoPause', 'DISPID_SPRNumberOfElements',
    'SPPS_RESERVED2', 'SPEI_SR_RETAINEDAUDIO', 'SPEVENT',
    'STSF_CommonAppData', 'DISPID_SREmulateRecognition',
    'ISpXMLRecoResult', 'SP_VISEME_0', 'SAFTDefault',
    ...
    'DISPID_SpeechAudioStatus', 'DISPID_SLPs_NewEnum',
    'SSFMCreateForWrite', 'SPPROPERTYINFO',
    'DISPID_SpeechPhraseAlternates', 'SPVISEMES',
    'DISPID_SVIsUISupported', 'SPLEXICONTYPE',
    'DISPID_SWFESamplesPerSec', 'ISpeechDataKey',
    'SAFT48kHz16BitStereo', 'DISPID_SPAPhraseInfo', 'SVSFPersistXML',
    'DISPID_SABufferNotifySize', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SGRSTWeight', 'SPGRAMMARWORDTYPE', 'eLEXTYPE_PRIVATE6',
    'SpFileStream', 'ISequentialStream', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVSInputSentenceLength', 'SREInterference',
    'DISPID_SRRPhraseInfo', 'ISpeechVoice', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPRFirstElement', 'SREAllEvents', 'SRTStandard',
    'DISPID_SBSSeek', 'SpeechGrammarWordType',
    'ISpeechGrammarRuleStateTransition', 'SPPARTOFSPEECH',
    'SREStreamEnd', 'SPPS_RESERVED4', 'DISPID_SGRSTPropertyName',
    'SPPHRASERULE', 'ISpeechObjectToken',
    'DISPID_SPEEngineConfidence', 'SGRSTTDictation',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRuleConfidence',
    'SP_VISEME_17', 'SSFMOpenReadWrite', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPAStartElementInResult', 'SRTReSent', 'ISpRecoResult',
    'SpeechRecoProfileProperties', 'SGRSTTRule', 'SpeechAllElements',
    'ISpeechMemoryStream', 'SPXMLRESULTOPTIONS', 'SP_VISEME_9',
    'ISpAudio', 'SPEI_SR_AUDIO_LEVEL', 'SPPS_Noun', 'SVEAudioLevel',
    'SPEI_START_SR_STREAM', 'STCLocalServer', 'SAFTGSM610_22kHzMono',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_12', 'SRAExport',
    'DISPID_SRIsUISupported', 'DISPID_SpeechPhraseRule',
    'SpeechUserTraining', 'DISPID_SOTGetDescription',
    'DISPID_SRCVoicePurgeEvent', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_PRIVATE12', 'DISPID_SpeechFileStream',
    'DISPID_SRGCmdLoadFromObject', 'SPSEMANTICFORMAT',
    'ISpResourceManager', 'SREAudioLevel', 'SRSInactiveWithPurge',
    'DISPID_SVStatus', 'DISPID_SPRuleChildren', 'ISpRecoGrammar',
    'DISPID_SGRAttributes', 'SSTTWildcard', 'DISPID_SVGetProfiles',
    'SPFM_OPEN_READONLY', 'DISPID_SPIEngineId', 'DISPID_SOTsCount',
    'SAFT22kHz8BitStereo', 'DISPID_SRCEInterference',
    'SpCustomStream', 'ISpeechPhraseReplacement',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SVSInputWordLength', 'DISPID_SGRAddResource',
    'SPAO_RETAIN_AUDIO', 'SREHypothesis', 'DISPID_SPRsItem',
    'SP_VISEME_7', 'DISPID_SVSVisemeId', 'SVSFVoiceMask',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPRuleParent',
    'DISPID_SOTMatchesAttributes', 'SRTEmulated',
    'SAFT24kHz8BitStereo', 'DISPID_SLPType', 'DISPID_SRRGetXMLResult',
    'SPSModifier', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechGrammarRuleState', 'SpeechGrammarState',
    'DISPID_SLPSymbolic', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechAudioBufferInfo',
    'SLODynamic', 'DISPID_SGRsAdd', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechBaseStream', 'IInternetSecurityMgrSite',
    'DISPID_SPPNumberOfElements', 'DISPID_SOTDisplayUI',
    'ISpeechPhraseProperties', 'SGDSActive', 'ISpeechPhraseRules',
    'SVEVoiceChange', 'SSTTTextBuffer', 'DISPID_SRRDiscardResultInfo',
    'SpeechMicTraining', 'DISPID_SPEsCount', 'DISPID_SVPriority',
    'SWPKnownWordPronounceable', 'SPSHT_EMAIL', 'SVPAlert',
    'SpAudioFormat', 'ISpEventSink', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpeechAudioBufferInfo', 'SAFTExtendedAudioFormat',
    '__MIDL_IWinTypes_0009', 'ISpeechRecoResult2', 'SPEVENTENUM',
    'SpeechTokenContext', 'SPSHORTCUTPAIR', 'SPCS_ENABLED',
    'SPLO_STATIC', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRGState', 'ISpeechPhraseInfoBuilder', 'SECFIgnoreWidth',
    'SPSHORTCUTTYPE', 'DISPID_SRRecognizer', 'SVSFParseAutodetect',
    'ISpSerializeState', 'SPEI_SOUND_START', 'SVP_19',
    'SpeechRegistryUserRoot', 'DISPID_SMSADeviceId',
    'DISPID_SRSNumberOfActiveRules', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SPRDisplayAttributes', 'SpeechCategoryRecognizers',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechRunState',
    'ISpeechLexiconWord', 'SDKLCurrentConfig', 'SPXRO_Alternates_SML',
    'DISPID_SRProfile', 'DISPID_SRGDictationUnload', 'SAFTText',
    'DISPID_SAFType', 'DISPID_SpeechMemoryStream',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTADPCM_8kHzStereo',
    'DISPID_SVDisplayUI', 'SpeechVoicePriority',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRSClsidEngine',
    'SpeechDiscardType', 'ISpeechPhraseReplacements',
    'DISPID_SpeechLexiconWord', 'SPSLMA', 'DISPID_SpeechAudioFormat',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCState', 'DISPID_SMSALineId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SRSActive',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRCreateRecoContext',
    'eLEXTYPE_USER', 'IEnumSpObjectTokens', 'SpeechCategoryAudioIn',
    'SASClosed', 'DISPID_SpeechPhraseElement', 'SRERecognition',
    'SP_VISEME_14', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPRsCount', 'SPGS_EXCLUSIVE',
    'DISPID_SRSSupportedLanguages', 'SRTSMLTimeout', 'SPCT_COMMAND',
    'DISPID_SRRAudio', 'SITooQuiet', 'SRSInactive',
    'SAFT22kHz16BitStereo', 'SREPrivate', 'SpeechAudioFormatGUIDText',
    'DISPID_SPERetainedStreamOffset', 'SAFTNonStandardFormat',
    'DISPID_SRCVoice', 'DISPID_SOTCGetDataKey', '_ISpeechVoiceEvents',
    'DISPID_SLAddPronunciationByPhoneIds', 'tagSPTEXTSELECTIONINFO',
    'ISpPhrase', 'SpeechEngineConfidence', 'SGRSTTEpsilon',
    'SGRSTTWildcard', 'SPEI_TTS_AUDIO_LEVEL', 'SAFTADPCM_11kHzStereo',
    'SDTAll', 'DISPID_SPIRetainedSizeBytes', 'SPINTERFERENCE_TOOFAST',
    'ISpeechRecoGrammar', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPIStartTime', 'eLEXTYPE_PRIVATE20', 'DISPID_SGRAddState',
    'DISPID_SRCEFalseRecognition', 'SpeechCategoryAppLexicons',
    'DISPID_SADefaultFormat', 'DISPID_SGRsCommit',
    'DISPID_SRGCmdLoadFromResource', 'SWTAdded',
    'SAFTADPCM_11kHzMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SDKGetlongValue'
]

_check_version('1.1.14', 1652520734.151109)
